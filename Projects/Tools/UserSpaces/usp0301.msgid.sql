...
begin
    ...
    set msgf = 'TOOMSGF';
    set msg = '&1 spool file, with number &2, from &3/&4/&5 job is eligible for deletion.';
    set msgid = 'USP0301';
    set work = '&N Cause . . . . . :   The request was to *LOGONLY when using SPLFDLT command.';
    set seclvl = rtrim(work);
    set work = ' If running again the request with *BOTH or *DLTONLY action, this spool file will be deleted.';
