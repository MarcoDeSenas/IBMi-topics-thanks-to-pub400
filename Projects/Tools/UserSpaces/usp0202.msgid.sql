...
begin
    ...
    set msgf = 'TOOMSGF';
    set msg = 'Format name "&1" is incorrect in user space &3/&2.';
    set msgid = 'USP0202';
    set work = '&N Cause . . . . . :   The API format name information expected to be found in user space is incorrect.';
    set seclvl = rtrim(work);
    set work = ' Either the information is empty or does not relate to any list API format name.';
    set seclvl = rtrim(seclvl) concat rtrim(work);
    set work = '&N Recovery  . . . :   Review the content of the user space.';
    set seclvl = rtrim(seclvl) concat rtrim(work);
    set work = ' The API format name is expected to be found at position 73.';
    set seclvl = rtrim(seclvl) concat rtrim(work);
